...
<body class="">
    ...
    <head class="bg-amber-300 w-full flex items-center justify-center gap-3">
        <div class="sm:w-full flex items-center justify-center mt-10">
            <h1 class="text-4xl text-pink-600 font-bold">Prontuário</h1>
        </div>
        ...
        <section class=" flex items-center justify-center">
            <form action="#" method="POST" class="grid grid-cols-2 gap-4">
                <div class=" flex flex-col">
                    ...
                    <input type="text" disabled name="nome" id="nome" value="Brutos" required class="p-3 w-lg border-2 border-pink-600 bg-pink-100 rounded-2xl focus:outline-none text-sm sm:text-base">
                </div>
                <div class="flex flex-col">
